...
-- CRIA TABELA CONTA
    ...
    CONSTRAINT BOOLEANO CHECK (EM_USO IN (0, 1))
);
...
CREATE TABLE HISTORICO_EXEC(
    ...
    INICIO DATE,
    FIM DATE,
    CONSTRAINT PK_HISTORICO PRIMARY KEY (CODIGO_USUARIO, USERNAME_LOGADO, USERNAME_COM_APP, CODIGO_APP, INICIO),
    ...
    CONSTRAINT FK_HISTORICO_COM_APP FOREIGN KEY (USERNAME_COM_APP) REFERENCES CONTA,
...
CREATE TABLE CONQUISTA(
    ...
    CONSTRAINT FK_CONQUISTA_HISTORICO FOREIGN KEY (CODIGO_USUARIO, USERNAME_LOGADO, USERNAME_COM_APP, CODIGO_APP, INICIO) REFERENCES HISTORICO_EXEC
);
