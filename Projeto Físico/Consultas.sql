...
-- AMIGOS EM COMUM ENTRE 'caiorochac' E 'mateusneeves' (OPERACAO DE CONJUNTO) --
SELECT *
FROM ((SELECT USERNAME1 AS AMIGOS FROM AMIGO WHERE USERNAME2 = 'caiorochac') UNION (SELECT USERNAME2 AS AMIGOS FROM AMIGO WHERE USERNAME1 = 'caiorochac'))
INTERSECT
((SELECT USERNAME1 AS AMIGOS FROM AMIGO WHERE USERNAME2 = 'mateusneeves') UNION (SELECT USERNAME2 AS AMIGOS FROM AMIGO WHERE USERNAME1 = 'mateusneeves'));
